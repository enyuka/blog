...
トヨタもWebエンジニアなどを集める求人を出している。
今ある自動車がただ自動運転になるわけではない。
...
ゆえに、`ITの方法論が実世界のサービスを巻き込む世界`がMaaSと言える。
...
時刻表を打ち込むと、GTFS形式で出力する。
~~つら・・・~~

[その筋屋](http://www.sinjidai.com/sujiya/)という無償配布している
バス事業運営に利用できるソフトウェア。
バス会社が運用できるレベルのクォリティらしい。

無償配布もできるので、バス会社も始められるクォリティとのことで、
バス会社運営に興味がある方はぜひ。
...
バスの乗り継ぎなどが経路検索しやすいとのことです。
下記画像は道玄坂の上あたりから六本木ヒルズまでの
経路検索してみました。

TODO画像貼る

渋谷駅にはバス停がたくさんあっちこっちにありますが、
...
現在→今まさにどうやって交通手段で移動するべきか？

未来→行きたいところへの経路探索や旅行の計画などはどうするのが最適？
...
しかし、現実は家から駅まで、駅から駅へはどのように移動するのか
といった詳細度の高い情報は得られない。

MaaSのシームレスな移動を提供するという観点から考えると、
機能が不足している現状がある。

また、ユーザはどのような属性を持っているかも考えることが必要。
...
実際の使用例として、画像トピックをカメラがPublishし、
信号認識や歩行者認識といったSubscriberが購読する。
...
[https://www.shimz.co.jp/company/about/news-release/2019/2019022.html](https://www.shimz.co.jp/company/about/news-release/2019/2019022.html)

### WebエンジニアっていうかIoTエンジニアっぽくない？？？
...
僕個人のスキルセットとして、
Web全般、特にWebRTCの開発経験が活かせそうだと感じた。
TODO ツイート貼る
...
リアルタイムで経路を変更しつつ、そのユーザも乗せていくアプリ。

### 便乗交通とは？

便乗は"便"利に"乗"る交通という意味合いをもたせている。
また、相乗りや乗り合いは別の意味がある(後述)。
...
信号機との連携ができて、監視などはDispatcherで行っている。
運行設定にはGTFS形式のダイヤデータを元に、
自動運転がダイヤ通りに運転される。

監視した結果のフィードバックを国に提出することで、
ガイドラインに適用ができるPDCAが回っている。
過去の走行を分析し、運行の改善も同時に行っている。
...
そのギャップを埋めるために、今回Mobility:devの開催する
動機になったとのことです。
...
2000年でIT革命が起き、
2010年からスマホで生活が変わった。
さらにこのインターネット・スマホ技術の地盤の上に、
モビリティの革命が起きる時代の流れがこれから起こりうる。

これが100年に一度の大変革の時代と言われる
ゆえんでもある。
